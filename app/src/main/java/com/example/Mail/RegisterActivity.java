...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 0){
            ...
            Bitmap bitmap = null;
            try {
               bitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), mSelectedPhotoUri);
    ...
    private void createUser() {
            ...
            if (name == null || name.isEmpty() || email == null || email.isEmpty() || senha == null || senha.isEmpty()) {
                Toast.makeText(RegisterActivity.this, "Nome, senha e e-mail devem ser preenchidos!", Toast.LENGTH_SHORT).show();
                return;
            }
